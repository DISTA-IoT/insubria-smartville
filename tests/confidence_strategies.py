...
def main() -> int:
    ...
    run_step(dash_cli_path, ["set", "intrusion_detection.confidence_strategy", "energy"])

    print("[step] Setting run name...", flush=True)
    run_step(dash_cli_path, ["set", "wandb.wb_run_name", "energy_conf"])
    ...
    run_step(dash_cli_path, ["set", "intrusion_detection.confidence_strategy", "margin"])

    print("[step] Setting run name...", flush=True)
    run_step(dash_cli_path, ["set", "wandb.wb_run_name", "margin_conf"])
    ...
    run_step(dash_cli_path, ["set", "intrusion_detection.confidence_strategy", "entropy"])

    print("[step] Setting run name...", flush=True)
    run_step(dash_cli_path, ["set", "wandb.wb_run_name", "entropy_conf"])
