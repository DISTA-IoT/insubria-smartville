...
def main() -> int:
    ...
    def recurrent_layers_sweep():
        ...
        run_step(dash_cli_path, ["set", "neural_modules.hidden_size", "100"])
        run_step(dash_cli_path, ["set", "wandb.wb_run_name", "h_100"])
        start_experiment()
        stop_experiment()

        run_step(dash_cli_path, ["set", "neural_modules.hidden_size", "200"])
        run_step(dash_cli_path, ["set", "wandb.wb_run_name", "h_200"])
        start_experiment()
        stop_experiment()

        run_step(dash_cli_path, ["set", "neural_modules.hidden_size", "400"])
        run_step(dash_cli_path, ["set", "wandb.wb_run_name", "h_400"])
        start_experiment()
        stop_experiment()

        run_step(dash_cli_path, ["set", "neural_modules.hidden_size", "600"])
        run_step(dash_cli_path, ["set", "wandb.wb_run_name", "h_600"])
        start_experiment()
        stop_experiment()
    ...
    run_step(dash_cli_path, ["set", "wandb.wb_group_name", "h_dims"])
