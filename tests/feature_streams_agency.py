...
def main() -> int:
    ...
    print("[step] Activating node features..." , flush=True)
    run_step(dash_cli_path, ["set", "node_features", "true"])

    print("[step] Setting run name...", flush=True)
    run_step(dash_cli_path, ["set", "wandb.wb_run_name", "agency_full"])
    ...
    print("[step] Setting run name...", flush=True)
    run_step(dash_cli_path, ["set", "wandb.wb_run_name", "flow_agency"])
    ...
    print("[step] Setting run name...", flush=True)
    run_step(dash_cli_path, ["set", "wandb.wb_run_name", "default"])
    ...
    print("[step] Setting run name...", flush=True)
    run_step(dash_cli_path, ["set", "wandb.wb_run_name", "flow_node_agency"])
